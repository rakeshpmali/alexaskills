...
const TestIntent_Handler =  {
    ...
    handle(handlerInput) {
        ...
        //var payloadObj={ "state": { "desired": {"pump": 0} } };
        var payloadObj={ "name" : "Office" };
        console.log("Payload :");
        ...
        var paramsPublish = {
            "topic" : '$aws/things/optimus-raspi/shadow/forward',
            "payload" : JSON.stringify(payloadObj),
            "qos" : 0
        };
...
const CreateZoneIntent_Handler =  {
    ...
    handle(handlerInput) {
        ...
        const jsonData = {"area":{"name" : areaName}, "zone":{"name" : zoneType}};
